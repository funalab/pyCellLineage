...
Last Modified: Sat, 02 Apr 2022 00:05:38 +0900
...
Regarding previously reported programs such as Schnitzcells(Young et al. 2012), and cellular transmission analysis (van Vliet et al. 2018) they are not included in pyCellLineage for license purposes.
...
- Supplementary Figure 9        
  ...
  Generated by van Vliet et. al's code for Randomization Testing.
...
Warnings:  
   For Experiments, Analysis_Gui uses paths that are hardcoded in pyCellLineage/Analysis_Gui/pathParms.py
...
## Data directory
The Data directory contains all raw CSVs and figures generated by pyCellLineage for the paper.
...
- glc_poor        
Images used for each specific sample analysis and generated CSVs/Figures by pyCellLineage.
...
- glc_poor/glc_rich  
  - sample X  
    - Pos0
        ...
        - saveimg
            Data storage directory for data generated by MATLAB using Schnitzcells and van Vliet et. al's code for cellular transmission.
